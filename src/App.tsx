  ...
  return (
    ...
    <div className="App overflow-x-hidden">
      ...
      <AuthProvider userApi={new userApi}>
        <AppShell assetsApi={new assetsApi("https://api.utopia-lab.org/assets/")} appName="Docutopia" nameWidth={180}>
        <Modal>
          <ModalContent/>
        </Modal>
          ...
          <Content>
            ...
            <Routes>
              <Route path="/*" element={<MapContainer />}>
                ...
                <Route path='reset-password' element={<RequestPasswordPage reset_url="https://next.docutopia.de/set-new-password/"/>}/>
